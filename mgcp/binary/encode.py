...
def encode(binary_message, l, parities_count, marker_period, export_json=False, export_path=None):
    ...
    match marker_period:
        case 0:
            codeword, n, N, K, q, U, X = GCP_Encode_binary_brute(binary_message, l, parities_count, codebook)

        case 1:
            codeword, n, N, K, q, U, X = MGCP_Encode_Binary_p1(binary_message, l, parities_count, codebook)

        case 2:
            codeword, n, N, K, q, U, X = MGCP_Encode_Binary_p2(binary_message, l, parities_count, codebook)
