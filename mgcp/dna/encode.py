from .GCP_Encode_DNA import GCP_Encode_DNA_brute
...
def encode(binary_message, l, parities_count, marker_period, export_json=False, export_path=None):
    """
    Encode a binary message using MGC+ DNA encoding.
    ...
    if l > 8 or l % 2 != 0:
        raise ValueError(f"Invalid block size l={l}. It must be even and not exceed 8.")
