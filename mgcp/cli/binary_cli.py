...
plot_app = typer.Typer(help="Plot FER vs. Pe or coderate for MGC+ Binary.")
app.add_typer(plot_app, name="plot")

@plot_app.command("fer-vs-coderate")
def plot_fer_vs_coderate_cli(
    ...
    pd_pi_ps_ratio: str = typer.Option("0.333,0.333,0.333",help="Comma-separated Pd, Pi, Ps ratio (e.g. '0.447,0.026,0.527')."),
    ...
    """
    Plot FER vs. coderate for Binary MGC+.
    """
